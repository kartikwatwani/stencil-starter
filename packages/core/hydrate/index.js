...
const NAMESPACE = 'inner-growth';
const BUILD = /* inner-growth */ { allRenderFn: true, appendChildSlotFix: false, asyncLoading: true, attachStyles: true, cloneNodeFix: false, cmpDidLoad: true, cmpDidRender: false, cmpDidUnload: false, cmpDidUpdate: false, cmpShouldUpdate: false, cmpWillLoad: false, cmpWillRender: false, cmpWillUpdate: false, connectedCallback: false, constructableCSS: false, cssAnnotations: true, devTools: false, disconnectedCallback: false, element: false, event: true, experimentalScopedSlotChanges: false, experimentalSlotFixes: false, formAssociated: false, hasRenderFn: true, hostListener: true, hostListenerTarget: false, hostListenerTargetBody: false, hostListenerTargetDocument: false, hostListenerTargetParent: false, hostListenerTargetWindow: false, hotModuleReplacement: false, hydrateClientSide: true, hydrateServerSide: true, hydratedAttribute: false, hydratedClass: true, hydratedSelectorName: "hydrated", invisiblePrehydration: false, isDebug: false, isDev: false, isTesting: false, lazyLoad: true, lifecycle: true, lifecycleDOMEvents: false, member: true, method: true, mode: false, observeAttribute: true, profile: false, prop: true, propBoolean: false, propMutable: true, propNumber: false, propString: true, reflect: true, scoped: false, scopedSlotTextContentFix: false, scriptDataOpts: false, shadowDelegatesFocus: false, shadowDom: true, shadowDomShim: true, slot: true, slotChildNodesFix: false, slotRelocation: true, state: true, style: true, svg: false, taskQueue: true, updatable: true, vdomAttribute: true, vdomClass: true, vdomFunctional: false, vdomKey: true, vdomListener: true, vdomPropOrAttr: true, vdomRef: true, vdomRender: true, vdomStyle: true, vdomText: true, vdomXlink: false, watchCallback: false };
...
var h$3 = (nodeName, vnodeData, ...children) => {
  let child = null;
  let key = null;
  let slotName = null;
  let simple = false;
...
var registerStyle = (scopeId2, cssText, allowCS) => {
  let style = styles$j.get(scopeId2);
  {
    style = cssText;
  }
  styles$j.set(scopeId2, style);
};
var addStyle = (styleContainerNode, cmpMeta, mode) => {
  var _a;
  const scopeId2 = getScopeId(cmpMeta);
  const style = styles$j.get(scopeId2);
...
var renderVdom = (hostRef, renderFnResults, isInitialLoad = false) => {
  ...
  const rootVnode = isHost(renderFnResults) ? renderFnResults : h$3(null, null, renderFnResults);
  ...
  if (Array.isArray(children) && children.length > 0) {
    ...
    if (flatChildren.some((child) => child instanceof Promise)) {
      return Promise.all(flatChildren).then((resolvedChildren) => {
        return h$3(nodeName, vnodeData, ...resolvedChildren);
      }).catch((err2) => {
        return h$3(nodeName, vnodeData);
      });
    }
    return h$3(nodeName, vnodeData, ...flatChildren);
  }
  return h$3(nodeName, vnodeData);
};
...
var styles$j = /* @__PURE__ */ new Map();

const matCardCss = ".card{position:relative;display:flex;flex-direction:column;min-width:0;height:var(--bs-card-height);color:var(--bs-body-color);word-wrap:break-word;background-color:var(--bs-card-bg);background-clip:border-box;border:var(--bs-card-border-width) solid var(--bs-card-border-color);border-radius:var(--bs-card-border-radius)}.mat-mdc-card{display:flex;flex-direction:column;box-sizing:border-box;position:relative;border-style:solid;border-width:0;background-color:rgb(250, 249, 253);border-color:rgb(250, 249, 253);border-radius:12px;box-shadow:0px 2px 1px -1px rgba(0, 0, 0, 0.2), 0px 1px 1px 0px rgba(0, 0, 0, 0.14), 0px 1px 3px 0px rgba(0, 0, 0, 0.12)}";
var MatCardStyle0 = matCardCss;
...
class MatCard {
    ...
    render() {
        return (hAsync(Host, { key: 'a8a635183bb17464947855d7862840f249dded5f', class: "mat-mdc-card card" }, hAsync("slot", { key: '860ee9253356d8cf944ea26c77550a4c0018597f' })));
    }
    static get style() { return MatCardStyle0; }
...
const matCardActionsCss = ":host{display:block}.mat-mdc-card-actions{display:flex;flex-direction:row;align-items:center;box-sizing:border-box;min-height:52px;padding:8px}";
var MatCardActionsStyle0 = matCardActionsCss;
...
class MatCardActions {
    ...
    render() {
        return (hAsync(Host, { key: '2b377e3e554f928602ad6b1b2e41f016dfb2992e', class: "mat-mdc-card-actions" }, hAsync("slot", { key: 'd51c32ac1aa5c2ee1a06a37fa107eb65e4190d0b' })));
    }
    static get style() { return MatCardActionsStyle0; }
    static get cmpMeta() { return {
        "$flags$": 4,
        "$tagName$": "mat-card-actions",
        "$members$": undefined,
        "$listeners$": undefined,
        "$lazyBundleId$": "-",
        "$attrsToReflect$": []
...
const matCardAvatarCss = ":host{display:block}.mat-mdc-card-avatar{height:40px;width:40px;border-radius:50%;flex-shrink:0;margin-bottom:16px;object-fit:cover}";
var MatCardAvatarStyle0 = matCardAvatarCss;
...
class MatCardAvatar {
    ...
    render() {
        return (hAsync(Host, { key: '7aae17fc36d7c3c372152583312622840e0cbe4e', class: "mat-mdc-card-avatar" }, hAsync("slot", { key: 'd14ca6ebfb4b52072010f55f33944499ed136562' })));
    }
    static get style() { return MatCardAvatarStyle0; }
    static get cmpMeta() { return {
        "$flags$": 4,
        "$tagName$": "mat-card-avatar",
        "$members$": undefined,
        "$listeners$": undefined,
        "$lazyBundleId$": "-",
        "$attrsToReflect$": []
...
const matCardContentCss = ":host{display:block}.mat-mdc-card-content{color:rgb(26, 27, 31);display:block;font-family:Roboto, \"Helvetica Neue Light\", \"Helvetica Neue\", Helvetica, Arial, \"Lucida Grande\", sans-serif;font-weight:400;padding-bottom:0px;padding-left:16px;padding-right:16px;padding-top:0px}.mat-mdc-card-content:last-child{padding-bottom:16px}.mat-mdc-card-content:first-child{padding-top:16px}.mat-mdc-card-content{display:block;padding:0 16px}";
var MatCardContentStyle0 = matCardContentCss;
...
class MatCardContent {
    ...
    render() {
        return (hAsync(Host, { key: '53b685a133df6b81be01b90b72aa6efe8df5c57f', class: "mat-mdc-card-content" }, hAsync("slot", { key: '7940e2d363055aadeef5778e07ecfd8023ee1099' })));
    }
    static get style() { return MatCardContentStyle0; }
    static get cmpMeta() { return {
        "$flags$": 4,
...
const matCardHeaderCss = ":host{display:block}.mat-mdc-card-header{display:flex;padding:16px 16px 0}.mat-mdc-card-subtitle~.mat-mdc-card-title,.mat-mdc-card-title~.mat-mdc-card-subtitle,.mat-mdc-card-header .mat-mdc-card-header-text .mat-mdc-card-title,.mat-mdc-card-header .mat-mdc-card-header-text .mat-mdc-card-subtitle,.mat-mdc-card-title-group .mat-mdc-card-title,.mat-mdc-card-title-group .mat-mdc-card-subtitle{padding-top:0}";
var MatCardHeaderStyle0 = matCardHeaderCss;
...
class MatCardHeader {
    ...
    render() {
        return (hAsync(Host, { key: '257bf4822414018897ebff2970844d6bbdaeef60', class: "mat-mdc-card-header" }, hAsync("slot", { key: '9f910bf41f191e80f3624bef994d760692b04431' })));
    }
    static get style() { return MatCardHeaderStyle0; }
    static get cmpMeta() { return {
        "$flags$": 4,
        "$tagName$": "mat-card-header",
        "$members$": undefined,
        "$listeners$": undefined,
        "$lazyBundleId$": "-",
        "$attrsToReflect$": []
...
const matCardImageCss = ":host{display:block}.mdc-card__media{position:relative;box-sizing:border-box;background-repeat:no-repeat;background-position:center;background-size:cover}";
var MatCardImageStyle0 = matCardImageCss;
...
class MatCardImage {
    ...
    render() {
        return (hAsync(Host, { key: '7f555a43f9c20b076d303882ab0930fe02c79096' }, hAsync("img", { key: '47d3022d5ad1116307cd35e7955dec41b48c8c30', src: this.src, class: "mdc-card__media" })));
    }
    static get style() { return MatCardImageStyle0; }
    static get cmpMeta() { return {
        "$flags$": 0,
        "$tagName$": "mat-card-image",
        "$members$": {
            "src": [1]
        },
        "$listeners$": undefined,
...
const matCardSubtitleCss = ":host{display:block}.mat-mdc-card-subtitle{color:rgb(26, 27, 31);font-family:Roboto, sans-serif;line-height:normal;font-size:16px;letter-spacing:0.144px;font-weight:500;display:block;margin:0;padding:16px 16px 0;padding-top:0}";
var MatCardSubtitleStyle0 = matCardSubtitleCss;
...
class MatCardSubtitle {
    ...
    render() {
        return (hAsync(Host, { key: '30bfffc5bb892890e8e512731995ad424dc01996', class: "mat-mdc-card-subtitle" }, hAsync("slot", { key: '8cb1fb7af18b17c8a3654241521eea5e952757b5' })));
    }
    static get style() { return MatCardSubtitleStyle0; }
    static get cmpMeta() { return {
        "$flags$": 4,
        "$tagName$": "mat-card-subtitle",
        "$members$": undefined,
        "$listeners$": undefined,
        "$lazyBundleId$": "-",
        "$attrsToReflect$": []
...
const matCardTitleCss = ":host{display:block}.mat-mdc-card-title{display:block;margin:0;font-family:Roboto, sans-serif;line-height:normal;font-size:22px;letter-spacing:normal;font-weight:400;padding:16px 16px 0;padding-top:0}";
var MatCardTitleStyle0 = matCardTitleCss;
...
class MatCardTitle {
    ...
    render() {
        return (hAsync(Host, { key: '4c8ef91e1461a45584e705be4b017329583f3736', class: "mat-mdc-card-title" }, hAsync("slot", { key: '2541848880b8b38eac91797e2fff1aeb3856b761' })));
    }
    static get style() { return MatCardTitleStyle0; }
    static get cmpMeta() { return {
        "$flags$": 4,
        "$tagName$": "mat-card-title",
        "$members$": undefined,
        "$listeners$": undefined,
        "$lazyBundleId$": "-",
        "$attrsToReflect$": []
 ...
 * SPDX-License-Identifier: Apache-2.0
 */
const styles$c = i$2 `.selected{--md-ripple-hover-color: var(--_selected-hover-state-layer-color);--md-ripple-hover-opacity: var(--_selected-hover-state-layer-opacity);--md-ripple-pressed-color: var(--_selected-pressed-state-layer-color);--md-ripple-pressed-opacity: var(--_selected-pressed-state-layer-opacity)}:where(.selected)::before{background:var(--_selected-container-color)}:where(.selected) .outline{border-width:var(--_selected-outline-width)}:where(.selected.disabled)::before{background:var(--_disabled-selected-container-color);opacity:var(--_disabled-selected-container-opacity)}:where(.selected) .label{color:var(--_selected-label-text-color)}:where(.selected:hover) .label{color:var(--_selected-hover-label-text-color)}:where(.selected:focus) .label{color:var(--_selected-focus-label-text-color)}:where(.selected:active) .label{color:var(--_selected-pressed-label-text-color)}:where(.selected) .leading.icon{color:var(--_selected-leading-icon-color)}:where(.selected:hover) .leading.icon{color:var(--_selected-hover-leading-icon-color)}:where(.selected:focus) .leading.icon{color:var(--_selected-focus-leading-icon-color)}:where(.selected:active) .leading.icon{color:var(--_selected-pressed-leading-icon-color)}@media(forced-colors: active){:where(.selected:not(.elevated))::before{border:1px solid CanvasText}:where(.selected) .outline{border-width:1px}}
`;
 ...
 * SPDX-License-Identifier: Apache-2.0
 */
const styles$4 = i$2 `:host{display:inline-flex;outline:none;resize:both;text-align:start;-webkit-tap-highlight-color:rgba(0,0,0,0)}.text-field,.field{width:100%}.text-field{display:inline-flex}.field{cursor:text}.disabled .field{cursor:default}.text-field,.textarea .field{resize:inherit}.icon{color:currentColor;display:flex;align-items:center;justify-content:center;fill:currentColor;position:relative}.icon ::slotted(*){display:flex;position:absolute}[has-start] .icon.leading{font-size:var(--_leading-icon-size);height:var(--_leading-icon-size);width:var(--_leading-icon-size)}[has-end] .icon.trailing{font-size:var(--_trailing-icon-size);height:var(--_trailing-icon-size);width:var(--_trailing-icon-size)}.input-wrapper{display:flex}.input-wrapper>*{all:inherit;padding:0}.input{caret-color:var(--_caret-color);overflow-x:hidden;text-align:inherit}.input::placeholder{color:currentColor;opacity:1}.input::-webkit-calendar-picker-indicator{display:none}.input::-webkit-search-decoration,.input::-webkit-search-cancel-button{display:none}@media(forced-colors: active){.input{background:none}}.no-spinner .input::-webkit-inner-spin-button,.no-spinner .input::-webkit-outer-spin-button{display:none}.no-spinner .input[type=number]{-moz-appearance:textfield}:focus-within .input{caret-color:var(--_focus-caret-color)}.error:focus-within .input{caret-color:var(--_error-focus-caret-color)}.text-field:not(.disabled) .prefix{color:var(--_input-text-prefix-color)}.text-field:not(.disabled) .suffix{color:var(--_input-text-suffix-color)}.text-field:not(.disabled) .input::placeholder{color:var(--_input-text-placeholder-color)}.prefix,.suffix{text-wrap:nowrap;width:min-content}.prefix{padding-inline-end:var(--_input-text-prefix-trailing-space)}.suffix{padding-inline-start:var(--_input-text-suffix-leading-space)}
`;
...
MdFilledTextField.styles = [styles$4, styles$5];
MdFilledTextField = __decorate([
    t$2('md-filled-text-field')
], MdFilledTextField);

const questionsViewerCss = ":host{display:block}";
var QuestionsViewerStyle0 = questionsViewerCss;
...
class QuestionsViewer {
    ...
    handleChipSelectionChange(event, questionId) {
        const target = event.target;
    ...
    handleSliderChange(event, questionId) {
        const target = event.target;
    ...
    // Render method
    render() {
        return (hAsync(Host, { key: 'a6d0b04ff22b0418b609b81cf1f69ac4deba3858' }, hAsync("form", { key: 'c279cf28ff5a09b9b9b674ba8f1744157356599a', id: "myForm", class: "questions" }, this.questions.map(question => (hAsync("div", { class: "question-item", key: question.id }, hAsync("p", null, question.text), this.renderQuestionByType(question)))))));
    }
    ...
    renderQuestionByType(question) {
        ...
        switch (question.type) {
            case 'chips':
                return (hAsync("md-chip-set", { name: question.id, ref: el => (this.chipset = el) }, question.options &&
                    question.options.map(option => (hAsync("md-filter-chip", { label: option, key: option })))));
            case 'slider':
                return (hAsync("md-slider", { style: { width: '100%' }, min: (_a = question.min) !== null && _a !== void 0 ? _a : 0, max: (_b = question.max) !== null && _b !== void 0 ? _b : 100, step: (_c = question.step) !== null && _c !== void 0 ? _c : 5, labeled: true, value: (_d = question.value) !== null && _d !== void 0 ? _d : (((_e = question.min) !== null && _e !== void 0 ? _e : 0) + ((_f = question.max) !== null && _f !== void 0 ? _f : 100)) / 2, onMdcChange: event => this.handleSliderChange(event, question.id) }));
            case 'textfield':
                return (hAsync("md-filled-text-field", { style: { width: '100%' }, label: question.text, placeholder: "I feel low in energy throughout the day...", type: question.valueType, rows: question.valueType === 'textarea' ? 5 : 1, onMdcChange: event => console.log(event.target.value) }));
            // Add more cases here for different question types
            default:
                return hAsync("p", null, "Unsupported question type: ", question.type);
        }
    }
    static get style() { return QuestionsViewerStyle0; }
    static get cmpMeta() { return {
        "$flags$": 9,
        "$tagName$": "questions-viewer",
        "$members$": {
            "questions": [16]
        },
        "$listeners$": undefined,
 ...
 * SPDX-License-Identifier: Apache-2.0
 */
const styles$2 = i$2 `md-elevation{transition-duration:280ms}:host(:is([disabled],[soft-disabled])) md-elevation{transition:none}md-elevation{--md-elevation-level: var(--_container-elevation);--md-elevation-shadow-color: var(--_container-shadow-color)}:host(:focus-within) md-elevation{--md-elevation-level: var(--_focus-container-elevation)}:host(:hover) md-elevation{--md-elevation-level: var(--_hover-container-elevation)}:host(:active) md-elevation{--md-elevation-level: var(--_pressed-container-elevation)}:host(:is([disabled],[soft-disabled])) md-elevation{--md-elevation-level: var(--_disabled-container-elevation)}
`;
...
const theJourneyBeginsCss = ":root{--md-sys-color-primary:#3B82F6;--md-sys-color-secondary:blue}:host{display:block;width:100%;height:100%;padding:0;margin:0}.center{display:flex;justify-content:center;align-items:center;width:100%;height:90dvh;padding:16px;box-sizing:border-box}.card{width:100%;max-width:400px;box-sizing:border-box;position:relative;overflow:hidden}.carousel{overflow:hidden;position:relative}.cards-container{display:flex;transition:transform 300ms cubic-bezier(0.4, 0.0, 0.2, 1);will-change:transform}.content{flex-shrink:0;width:100%;box-sizing:border-box}img{display:block;width:100%}@media (prefers-reduced-motion: reduce){.cards-container{transition:none}}";
var TheJourneyBeginsStyle0 = theJourneyBeginsCss;
...
class TheJourneyBegins {
    ...
    render() {
        return (hAsync(Host, { key: '323206ce39370a2a5e2785242605162aa9daa716' }, hAsync("div", { key: '0c9f014f1a1268dc9c710e46c0670e003dc0ea8a', class: "center" }, hAsync("mat-card", { key: '71bde47a1d42cd5bf603b121524c9f403a156130', class: "card" }, hAsync("div", { key: '5c6788294a820bc8dd1aee78fcd4be497c52cb15', class: "carousel" }, hAsync("div", { key: '042fefae76ec5a2922ea675011b8b497f5ff0b60', class: "cards-container", style: {
                transform: `translateX(-${this.activeIndex * 100}%)`,
            } }, this.cards.map(card => (hAsync("div", { class: "content" }, this.renderContent(card)))))), hAsync("mat-card-actions", { key: '7dcf60d972c1bbf16a385d309afc79ace90bc0df', style: {
                justifyContent: 'space-between',
                margin: '8px',
                gap: '8px',
            } }, hAsync("div", { key: '30f6961abc0d9b13026fba61bb649366729bbb89' }, this.activeIndex > 0 && (hAsync("md-outlined-button", { key: '3a32d915b3616ec96e6a318fa134d9d1b1654c4d', onClick: () => this.onPrev(), disabled: this.animating }, "Back"))), hAsync("div", { key: '515e28ff2b75a23ed2567d5c5083c3c8e69af6ac' }, this.activeIndex < this.cards.length - 1 && (hAsync("md-filled-button", { key: 'd849a4ab6c6921ec3202941fea247055c99121ad', onClick: () => this.onNext(), disabled: this.animating }, "Next"))))))));
    }
    renderContent(card) {
        return (hAsync("div", null, hAsync("mat-card-header", { style: { marginBottom: '16px' } }, hAsync("div", null, hAsync("mat-card-title", null, card.title))), hAsync("mat-card-content", null, card.image && hAsync("img", { src: card.image }), card.body && hAsync("p", null, card.body), card.questions && (hAsync("questions-viewer", { questions: card.questions })))));
    }
    onNext() {
    ...
    static get style() { return TheJourneyBeginsStyle0; }
    static get cmpMeta() { return {
        "$flags$": 0,
        "$tagName$": "the-journey-begins",
        "$members$": {
            "answers": [32],
            "activeIndex": [32],
            "animating": [32]
...
const yogaVideosCss = ".video-grid{display:grid;grid-template-columns:repeat(auto-fill, minmax(320px, 1fr));gap:16px;margin:16px}.video-wrapper{display:flex;flex-direction:column;align-items:center;}.video-thumbnail{cursor:pointer;transition:transform 0.3s;position:relative;width:100%;padding-bottom:56.25%;overflow:hidden}.video-thumbnail-img{position:absolute;top:0;left:0;width:100%;height:100%;object-fit:cover}.video-title{margin-top:8px;text-align:center;font-size:14px;color:#666}.video-thumbnail:hover{transform:scale(1.1)}.video-player{position:fixed;top:0;left:0;width:100vw;height:100vh;background-color:rgba(0, 0, 0, 0.8);display:flex;justify-content:center;align-items:center;opacity:0;visibility:hidden;transition:opacity 0.3s ease,\n    visibility 0s linear 0.3s;z-index:3}.video-player.active{opacity:1;visibility:visible;transition:opacity 0.3s ease}.youtube-player{width:80dvw;max-width:800px;height:45dvw}";
var YogaVideosStyle0 = yogaVideosCss;
...
class YogaVideos {
    ...
    render() {
        return (hAsync("div", { key: 'f1d0517024cb3d4b933ab29d930f9bd3f2211734' }, hAsync("div", { key: '7a66ae28ce39912273355a6718048e36d1821225', class: "video-grid" }, this.videos.map(video => (hAsync("div", { class: "video-wrapper" }, hAsync("div", { class: "video-thumbnail", onClick: () => this.playVideo(video.videoId) }, hAsync("img", { width: "320", class: "video-thumbnail-img", src: video.thumbnail })), hAsync("div", { class: "video-title" }, video.title), ' ')))), this.isPlaying && (hAsync("div", { key: 'bb0820ac5717855dea948b46e279196f12fa916e', class: { active: this.isPlaying, 'video-player': true }, onClick: () => this.closePlayer() }, hAsync("div", { key: 'a867cce22b59ac5bb75469faabf0e5518096ea4d', class: "player-container", onClick: event => event.stopPropagation() }, hAsync("youtube-player", { key: 'ad48399865a9d386fc35acd05d7016065aedfc95', videoId: this.currentVideoId, onReady: event => this.onPlayerReady(event), onStateChange: event => this.onPlayerStateChange(event) }))))));
    }
    static get style() { return YogaVideosStyle0; }
    static get cmpMeta() { return {
        "$flags$": 9,
        "$tagName$": "yoga-videos",
        "$members$": {
...
const youtubePlayerCss = ":host{display:block}";
var YoutubePlayerStyle0 = youtubePlayerCss;

class YoutubePlayer {
    constructor(hostRef) {
        registerInstance(this, hostRef);
        this.playerReady = createEvent(this, "ready", 7);
        this.playerStateChange = createEvent(this, "stateChange", 7);
    ...
    render() {
        return (hAsync("host", { key: '6db6a72eea615679eadd3ed74abc6be095b816ac' }, hAsync("section", { key: '2c1aac3152ce44ca3bc1dcfd2520b12a5a6599be', class: "backdrop", ref: el => (this.backdrop = el) }, hAsync("div", { key: '48c1f7db0f0819942672911e702e9eb4edf175b5', class: "loader", ref: el => (this.loader = el) }, "Loading...")), hAsync("div", { key: '8a6a47f7d522dd57ac54984f1afad55934ce6f72', id: "player", ref: el => (this.iframe = el) })));
    }
    componentDidLoad() {
    ...
    static get style() { return YoutubePlayerStyle0; }
    static get cmpMeta() { return {
        "$flags$": 9,
        "$tagName$": "youtube-player",
        "$members$": {
            "videoId": [1537, "video-id"],
            "width": [1537],
            "height": [1537],
            "load": [32],
            "play": [64],
        ...
        "$listeners$": [[0, "onReady", "readyIframeHandler"]],
        "$lazyBundleId$": "-",
        "$attrsToReflect$": [["videoId", "video-id"], ["width", "width"], ["height", "height"]]
    }; }
}
